    ...
    return (
      <main className="flex-grow m-2 md:m-4">
        ...
        <p className="pt-8 pb-8 m-2 sm:p-14 font-light">
          ...
          <span className="half-bg hover:half-bg-hover">full-stack</span>{" "}
          capabilities. This site was built using the MERN stack with{" "}
          <span className="half-bg hover:half-bg-hover">Tailwind</span> for
          styling. If you{" "}
          ...
          <span className="half-bg hover:half-bg-hover">React</span> and
          Tailwind. <span className="half-bg hover:half-bg-hover">Express</span>{" "}
          and <span className="half-bg hover:half-bg-hover">Node.js</span> are
          used on the backend and{" "}
          <span className="half-bg hover:half-bg-hover">MongoDB</span> is the
          database used for storage. As you probably know, most of this stuff,
          specifically the project data, could have all been handled on the
          client side. However, the goal of this site is to display full-stack
          capabilities. So please, poke around the site, check out my socials,
          add your name to the table in the visitors section, and feel free to
          reach out!{" "}
        </p>
        <Resume />
        <OpenSource />
