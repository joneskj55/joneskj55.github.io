    ...
    return (
      <main className="flex-grow m-2 md:m-4">
        ...
        <p className="lg:text-lg pt-8 pb-8 m-2 sm:p-14 font-light">
          ...
          <span className="half-bg cursor-default">full-stack</span>{" "}
          capabilities. This site was built using the MERN stack with{" "}
          <span className="half-bg cursor-default">Tailwind</span> for styling.
          If you{" "}
          ...
          <span className="half-bg cursor-default">Node.js</span> are used on
          the backend and{" "}
          <span className="half-bg cursor-default">MongoDB</span> is the
